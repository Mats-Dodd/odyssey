...
import { c as F } from '../chunks/SV1JYOhp.js';
import { R as Ae, T as Ie, C as Me } from '../chunks/DnqHzMrx.js';
import { L as K } from '../chunks/D9yiXxoh.js';
import { M as re } from '../chunks/BMSQkwth.js';
import { L as Ne, C as Oe } from '../chunks/BOy_XFTJ.js';
import { L as ze } from '../chunks/B0Zr7OpR.js';
function se(a, e, t) {
	const l = a.slice();
	return (l[14] = e[t]), l;
}
...
function He(a) {
	...
	return (
		...
		})),
		{
			...
			l(s) {
				E(e.$$.fragment, s), (t = b(s)), (l = T(s, 'P', { class: !0 }));
				var i = x(l);
			...
			m(s, i) {
				y(e, s, i), g(s, t, i), g(s, l, i), M(l, o), (n = !0);
			},
			p(s, i) {
				const c = {};
				i & 6 &&
...
function ne(a, e) {
	...
	return {
		...
		m(c, u) {
			g(c, t, u), l.m(r, t), M(t, o), n || ((s = ue(t, 'click', i)), (n = !0));
		},
		p(c, u) {
			(e = c),
				u & 4 &&
...
function Re(a) {
	...
	return {
		...
		p(n, s) {
			s & 756 && ((r = C(n[2][n[14]])), (e = me(e, s, o, 1, n, r, t, l.parentNode, Ve, ne, l, le)));
		},
		d(n) {
			n && p(l);
...
function ce(a) {
	...
	return (
		...
		})),
		{
			...
			m(n, s) {
				g(n, e, s), y(t, e, null), M(e, l), y(r, e, null), (o = !0);
			},
			i(n) {
...
function Be(a) {
	...
	return {
		...
		p(f, [d]) {
			const D = {};
			d & 1048577 && (D.$$scope = { dirty: d, ctx: f }),
				t.$set(D),
...
function Ue(a, e, t) {
	...
	async function d() {
		t(3, (i = !0));
		try {
			t(0, (s = await xe(be(pe), '- [ ]', !1, !1))), t(3, (i = !1));
		} catch (_) {
			console.error('Error searching files:', _);
		}
	}
	const D = X.subscribeToSaveEvents(async () => {
		d();
	});
	$e(async () => {
		var A;
		Z.set(null), await d();
		const _ = s.find((I) => I.path === l);
				...
				setTimeout(() => {
					o || ee.set(!0),
						...
						n !== A.context_preview.replaceAll('- [ ]', '').trim() &&
							B.set(A.context_preview.replaceAll('- [ ]', '').trim()),
						f(I),
						r.commands.setSearchResult(I);
				}, 300);
		};
	return (
		(a.$$.update = () => {
...
function Ge(a) {
	...
	return (
		(o = new Xe({})),
		{
			...
			l(m) {
				e = T(m, 'DIV', { class: !0, style: !0 });
				var f = x(e);
				(t = T(f, 'DIV', { class: !0, role: !0 })),
					x(t).forEach(p),
					(l = b(f)),
					(r = T(f, 'DIV', { class: !0, 'data-collection-root': !0, 'data-path': !0 }));
				var d = x(r);
...
function Ke(a) {
	...
	return {
		...
		p(r, o) {
			l && l.p && (!e || o & 2) && Se(l, t, r, r[1], e ? Te(t, r[1], o, null) : Le(r[1]), null);
		},
		i(r) {
			e || (h(l, r), (e = !0));
		},
...
function Qe(a) {
	let e, t, l;
	return (
		(t = new ze({ props: { sidebar: We, $$slots: { default: [Ke] }, $$scope: { ctx: a } } })),
		{
			c() {
