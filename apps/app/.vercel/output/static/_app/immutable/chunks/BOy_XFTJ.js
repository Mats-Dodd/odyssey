import { s as _, x as r, A as c, E as m, F as d, G as g, H as $ } from './wdwkOUVI.js';
import { S as p, i as h, d as y, t as f, a as u, m as N, c as b, b as v } from './JshcQj11.js';
import { g as x, a as C } from './SV1JYOhp.js';
...
function S(a) {
	...
	return (
		(e = new I({ props: t })),
		{
			...
			p(n, [l]) {
				const i = l & 3 ? x(o, [o[0], l & 2 && C(n[1]), l & 1 && { iconNode: n[0] }]) : {};
...
class z extends p {
	constructor(e) {
		super(), h(this, e, E, A, _, {});
	}
}
export { w as C, z as L };
