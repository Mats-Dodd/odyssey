...
function Z(u, e) {
	typeof e != 'string' && (e = Z.defaultChars);
	const r = C0(e);
	return u.replace(/(%[a-f0-9]{2})+/gi, function (t) {
		...
		for (let c = 0, o = t.length; c < o; c += 3) {
			...
			if ((i & 240) === 224 && c + 6 < o) {
				const a = parseInt(t.slice(c + 4, c + 6), 16),
					f = parseInt(t.slice(c + 7, c + 9), 16);
				if ((a & 192) === 128 && (f & 192) === 128) {
					const s = ((i << 12) & 61440) | ((a << 6) & 4032) | (f & 63);
					s < 2048 || (s >= 55296 && s <= 57343) ? (n += '���') : (n += String.fromCharCode(s)),
						(c += 6);
					continue;
				}
			}
			if ((i & 248) === 240 && c + 9 < o) {
				const a = parseInt(t.slice(c + 4, c + 6), 16),
					f = parseInt(t.slice(c + 7, c + 9), 16),
					s = parseInt(t.slice(c + 10, c + 12), 16);
				if ((a & 192) === 128 && (f & 192) === 128 && (s & 192) === 128) {
					let d = ((i << 18) & 1835008) | ((a << 12) & 258048) | ((f << 6) & 4032) | (s & 63);
					d < 65536 || d > 1114111
						? (n += '����')
						: ((d -= 65536), (n += String.fromCharCode(55296 + (d >> 10), 56320 + (d & 1023)))),
						(c += 9);
					continue;
				}
			}
...
nu.prototype.parse = function (u, e) {
	...
	if (((c = c.trim()), !e && u.split('#').length === 1)) {
		const f = y0.exec(c);
		if (f) return (this.pathname = f[1]), f[2] && (this.search = f[2]), this;
	}
	let o = F0.exec(c);
	if (
		(o && ((o = o[0]), (r = o.toLowerCase()), (this.protocol = o), (c = c.substr(o.length))),
		(e || o || c.match(/^\/\/[^@\/]+@[^@\/]+/)) &&
			((n = c.substr(0, 2) === '//'),
			n && !(o && qu[o]) && ((c = c.substr(2)), (this.slashes = !0))),
		!qu[o] && (n || (o && !Ru[o])))
	) {
		let f = -1;
		for (let l = 0; l < Iu.length; l++)
			(t = c.indexOf(Iu[l])), t !== -1 && (f === -1 || t < f) && (f = t);
		let s, d;
		f === -1 ? (d = c.lastIndexOf('@')) : (d = c.lastIndexOf('@', f)),
			d !== -1 && ((s = c.slice(0, d)), (c = c.slice(d + 1)), (this.auth = s)),
			(f = -1);
		for (let l = 0; l < zu.length; l++)
			(t = c.indexOf(zu[l])), t !== -1 && (f === -1 || t < f) && (f = t);
		f === -1 && (f = c.length), c[f - 1] === ':' && f--;
		const b = c.slice(0, f);
		(c = c.slice(f)), this.parseHost(b), (this.hostname = this.hostname || '');
		...
		this.hostname.length > B0 && (this.hostname = ''),
	...
	return (
		...
		c && (this.pathname = c),
		Ru[r] && this.hostname && !this.pathname && (this.pathname = ''),
		this
	);
};
...
const z0 = Object.freeze(
		Object.defineProperty(
			{ __proto__: null, decode: Z, encode: Y, format: Du, parse: Cu },
			Symbol.toStringTag,
			{ value: 'Module' }
		)
	),
	...
	M0 = Object.freeze(
		Object.defineProperty(
			{ __proto__: null, Any: Wu, Cc: Ju, Cf: I0, P: Eu, S: Qu, Z: Xu },
			Symbol.toStringTag,
			{ value: 'Module' }
		)
	),
...
const L0 = new Map([
	...
	P0 =
		(lu = String.fromCodePoint) !== null && lu !== void 0
			? lu
			: function (u) {
					let e = '';
					return (
...
function $0(u) {
	return (u >= A.UPPER_A && u <= A.UPPER_Z) || (u >= A.LOWER_A && u <= A.LOWER_Z) || mu(u);
}
function U0(u) {
	return u === A.EQUALS || $0(u);
}
var F;
(function (u) {
...
class Z0 {
	...
	write(e, r) {
		switch (this.state) {
			case F.EntityStart:
				return e.charCodeAt(r) === A.NUM
					? ((this.state = F.NumericStart), (this.consumed += 1), this.stateNumericStart(e, r + 1))
					: ((this.state = F.NamedEntity), this.stateNamedEntity(e, r));
			case F.NumericStart:
	...
	stateNumericStart(e, r) {
		return r >= e.length
			? -1
			: (e.charCodeAt(r) | N0) === A.LOWER_X
				? ((this.state = F.NumericHex), (this.consumed += 1), this.stateNumericHex(e, r + 1))
				: ((this.state = F.NumericDecimal), this.stateNumericDecimal(e, r));
	}
	addToNumericResult(e, r, t, n) {
		if (r !== t) {
			const c = t - r;
			(this.result = this.result * Math.pow(n, c) + parseInt(e.substr(r, c), n)),
				(this.consumed += c);
		}
	}
	stateNumericHex(e, r) {
		...
		for (; r < e.length; ) {
			...
			if (mu(n) || j0(n)) r += 1;
			else return this.addToNumericResult(e, t, r, 16), this.emitNumericEntity(n, 3);
		}
	...
	stateNumericDecimal(e, r) {
		...
		for (; r < e.length; ) {
			const n = e.charCodeAt(r);
			if (mu(n)) r += 1;
			else return this.addToNumericResult(e, t, r, 10), this.emitNumericEntity(n, 2);
		}
	...
	emitNumericEntity(e, r) {
		...
		return (
			this.emitCodePoint(O0(this.result), this.consumed),
			this.errors &&
	...
	stateNamedEntity(e, r) {
		...
		let n = t[this.treeIndex],
			c = (n & O.VALUE_LENGTH) >> 14;
		for (; r < e.length; r++, this.excess++) {
			const o = e.charCodeAt(r);
			if (((this.treeIndex = H0(t, n, this.treeIndex + Math.max(1, c), o)), this.treeIndex < 0))
				return this.result === 0 || (this.decodeMode === P.Attribute && (c === 0 || U0(o)))
					? 0
					: this.emitNotTerminatedNamedEntity();
			if (((n = t[this.treeIndex]), (c = (n & O.VALUE_LENGTH) >> 14), c !== 0)) {
				if (o === A.SEMI)
	...
	emitNotTerminatedNamedEntity() {
		var e;
		const { result: r, decodeTree: t } = this,
			n = (t[r] & O.VALUE_LENGTH) >> 14;
		return (
	...
	emitNamedEntityData(e, r, t) {
		...
		return (
			this.emitCodePoint(r === 1 ? n[e] & ~O.VALUE_LENGTH : n[e + 1], t),
			r === 3 && this.emitCodePoint(n[e + 2], t),
			t
		);
	}
	end() {
...
function Yu(u) {
	let e = '';
	const r = new Z0(u, (t) => (e += P0(t)));
	return function (n, c) {
		let o = 0,
			i = 0;
		for (; (i = n.indexOf('&', i)) >= 0; ) {
			(e += n.slice(o, i)), r.startEntity(c);
			const f = r.write(n, i + 1);
			if (f < 0) {
				o = i + r.end();
				break;
			}
...
function H0(u, e, r, t) {
	const n = (e & O.BRANCH_LENGTH) >> 7,
		c = e & O.JUMP_TABLE;
	if (n === 0) return c !== 0 && t === c ? r : -1;
	if (c) {
		const a = t - c;
...
function Fu(u) {
	return G0(u) === '[object String]';
}
const W0 = Object.prototype.hasOwnProperty;
function J0(u, e) {
	return W0.call(u, e);
}
function iu(u) {
...
const e0 = /\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g,
	Q0 = /&([a-z#][a-z0-9]{1,31});/gi,
	X0 = new RegExp(e0.source + '|' + Q0.source, 'gi'),
	Y0 = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))$/i;
function K0(u, e) {
	if (e.charCodeAt(0) === 35 && Y0.test(e)) {
...
function ue(u) {
	return u.indexOf('\\') < 0 ? u : u.replace(e0, '$1');
}
function H(u) {
	return u.indexOf('\\') < 0 && u.indexOf('&') < 0
		? u
		: u.replace(X0, function (e, r, t) {
				return r || K0(e, t);
			});
}
const ee = /[&<>"]/,
...
function N(u) {
	return ee.test(u) ? u.replace(re, te) : u;
}
const ce = /[.?*+^$[\]\\(){}|-]/g;
function ie(u) {
	return u.replace(ce, '\\$&');
...
function se(u, e, r) {
	...
	if (u.charCodeAt(n) === 60) {
		for (n++; n < r; ) {
			if (((t = u.charCodeAt(n)), t === 10 || t === 60)) return c;
			if (t === 62) return (c.pos = n + 1), (c.str = H(u.slice(e + 1, n))), (c.ok = !0), c;
			if (t === 92 && n + 1 < r) {
				n += 2;
				continue;
			}
	...
	for (; n < r && ((t = u.charCodeAt(n)), !(t === 32 || t < 32 || t === 127)); ) {
		if (t === 92 && n + 1 < r) {
			if (u.charCodeAt(n + 1) === 32) break;
			n += 2;
			continue;
		}
		if (t === 40 && (o++, o > 32)) return c;
		if (t === 41) {
			if (o === 0) break;
			o--;
		}
	...
	return e === n || o !== 0 || ((c.str = H(u.slice(e, n))), (c.pos = n), (c.ok = !0)), c;
}
function le(u, e, r, t) {
	let n,
		c = e;
	const o = { ok: !1, can_continue: !1, pos: 0, str: '', marker: 0 };
	if (t) (o.str = t.str), (o.marker = t.marker);
	else {
		if (c >= r) return o;
	...
	for (; c < r; ) {
		if (((n = u.charCodeAt(c)), n === o.marker))
			return (o.pos = c + 1), (o.str += H(u.slice(e, c))), (o.ok = !0), o;
		if (n === 40 && o.marker === 41) return o;
		n === 92 && c + 1 < r && c++, c++;
	}
	return (o.can_continue = !0), (o.str += H(u.slice(e, c))), o;
}
const de = Object.freeze(
		Object.defineProperty(
			{ __proto__: null, parseLinkDestination: se, parseLinkLabel: fe, parseLinkTitle: le },
			Symbol.toStringTag,
			{ value: 'Module' }
		)
	),
	M = {};
M.code_inline = function (u, e, r, t, n) {
	const c = u[e];
	return '<code' + n.renderAttrs(c) + '>' + N(c.content) + '</code>';
};
M.code_block = function (u, e, r, t, n) {
	const c = u[e];
	return (
		'<pre' +
		n.renderAttrs(c) +
...
M.fence = function (u, e, r, t, n) {
	const c = u[e],
		o = c.info ? H(c.info).trim() : '';
	let i = '',
		a = '';
	if (o) {
		const s = o.split(/(\s+)/g);
		(i = s[0]), (a = s.slice(2).join(''));
	}
	let f;
	if (
		(r.highlight ? (f = r.highlight(c.content, i, a) || N(c.content)) : (f = N(c.content)),
		f.indexOf('<pre') === 0)
	)
		return (
			f +
...
`
	...
	if (o) {
		const s = c.attrIndex('class'),
			d = c.attrs ? c.attrs.slice() : [];
		s < 0
			? d.push(['class', r.langPrefix + i])
			: ((d[s] = d[s].slice()), (d[s][1] += ' ' + r.langPrefix + i));
		const b = { attrs: d };
		return `<pre><code${n.renderAttrs(b)}>${f}</code></pre>
`;
	}
	return `<pre><code${n.renderAttrs(c)}>${f}</code></pre>
`;
};
M.image = function (u, e, r, t, n) {
	const c = u[e];
	return (
		(c.attrs[c.attrIndex('alt')][1] = n.renderInlineAsText(c.children, r, t)),
		n.renderToken(u, e, r)
	);
};
M.hardbreak = function (u, e, r) {
	return r.xhtmlOut
		? `<br />
`
		: `<br>
...
`),
		(c += (n.nesting === -1 ? '</' : '<') + n.tag),
		(c += this.renderAttrs(n)),
		n.nesting === 0 && t.xhtmlOut && (c += ' /');
	let o = !1;
...
V.prototype.render = function (u, e, r) {
	...
	for (let c = 0, o = u.length; c < o; c++) {
		const i = u[c].type;
		i === 'inline'
			? (t += this.renderInline(u[c].children, e, r))
			: typeof n[i] < 'u'
				? (t += n[i](u, c, e, r, this))
				: (t += this.renderToken(u, c, e, r));
	}
	return t;
};
function w() {
...
w.prototype.before = function (u, e, r, t) {
	const n = this.__find__(u),
		c = t || {};
	if (n === -1) throw new Error('Parser rule not found: ' + u);
	this.__rules__.splice(n, 0, { name: e, enabled: !0, fn: r, alt: c.alt || [] }),
		(this.__cache__ = null);
};
w.prototype.after = function (u, e, r, t) {
	const n = this.__find__(u),
		c = t || {};
	if (n === -1) throw new Error('Parser rule not found: ' + u);
	this.__rules__.splice(n + 1, 0, { name: e, enabled: !0, fn: r, alt: c.alt || [] }),
		(this.__cache__ = null);
};
w.prototype.push = function (u, e, r) {
	const t = r || {};
	this.__rules__.push({ name: u, enabled: !0, fn: e, alt: t.alt || [] }), (this.__cache__ = null);
};
...
T.prototype.attrIndex = function (e) {
	...
	const r = this.attrs;
	for (let t = 0, n = r.length; t < n; t++) if (r[t][0] === e) return t;
	return -1;
};
...
function ge(u) {
	...
	if (u.md.options.linkify)
		for (let r = 0, t = e.length; r < t; r++) {
			if (e[r].type !== 'inline' || !u.md.linkify.pretest(e[r].content)) continue;
			let n = e[r].children,
				c = 0;
			for (let o = n.length - 1; o >= 0; o--) {
				const i = n[o];
				if (i.type === 'link_close') {
					for (o--; n[o].level !== i.level && n[o].type !== 'link_open'; ) o--;
					continue;
				}
				if (
					(i.type === 'html_inline' && (me(i.content) && c > 0 && c--, ke(i.content) && c++),
					...
					f.length > 0 &&
						f[0].index === 0 &&
						o > 0 &&
						n[o - 1].type === 'text_special' &&
						(f = f.slice(1));
					for (let h = 0; h < f.length; h++) {
						const l = f[h].url,
							k = u.md.normalizeLink(l);
						if (!u.md.validateLink(k)) continue;
						let g = f[h].text;
						f[h].schema
							? f[h].schema === 'mailto:' && !/^mailto:/i.test(g)
								? (g = u.md.normalizeLinkText('mailto:' + g).replace(/^mailto:/, ''))
								: (g = u.md.normalizeLinkText(g))
							: (g = u.md.normalizeLinkText('http://' + g).replace(/^http:\/\//, ''));
						const C = f[h].index;
						if (C > b) {
							const m = new u.Token('text', '', 0);
							(m.content = a.slice(b, C)), (m.level = d), s.push(m);
						}
						...
						(_.content = g), (_.level = d), s.push(_);
					...
					if (b < a.length) {
						...
						(h.content = a.slice(b)), (h.level = d), s.push(h);
					}
					e[r].children = n = u0(n, o, s);
				}
			}
		}
}
...
function Ae(u) {
	...
	for (let r = u.length - 1; r >= 0; r--) {
		const t = u[r];
		t.type === 'text' && !e && (t.content = t.content.replace(Ce, Fe)),
			t.type === 'link_open' && t.info === 'auto' && e--,
			t.type === 'link_close' && t.info === 'auto' && e++;
	}
}
function ye(u) {
	let e = 0;
	...
	if (u.md.options.typographer)
		for (e = u.tokens.length - 1; e >= 0; e--)
			u.tokens[e].type === 'inline' &&
				(De.test(u.tokens[e].content) && Ae(u.tokens[e].children),
				n0.test(u.tokens[e].content) && ye(u.tokens[e].children));
}
const Se = /['"]/,
	Lu = /['"]/g,
	Pu = '’';
...
function ve(u, e) {
	...
	for (let n = 0; n < u.length; n++) {
		...
		if (((t.length = r + 1), c.type !== 'text')) continue;
		let i = c.content,
			a = 0,
			f = i.length;
		u: for (; a < f; ) {
			...
			const h = s[0] === "'";
			let l = 32;
			if (s.index - 1 >= 0) l = i.charCodeAt(s.index - 1);
			else
			...
			let k = 32;
			if (a < f) k = i.charCodeAt(a);
			else
				for (
					r = n + 1;
					r < u.length && !(u[r].type === 'softbreak' || u[r].type === 'hardbreak');
					r++
				)
					if (u[r].content) {
						k = u[r].content.charCodeAt(0);
						break;
					}
			const g = Q(l) || J(String.fromCharCode(l)),
				C = Q(k) || J(String.fromCharCode(k)),
				p = W(l),
				_ = W(k);
			if (
				(_ ? (d = !1) : C && (p || g || (d = !1)),
				p ? (b = !1) : g && (_ || C || (b = !1)),
				k === 34 && s[0] === '"' && l >= 48 && l <= 57 && (b = d = !1),
				d && b && ((d = g), (b = C)),
				!d && !b)
			) {
				h && (c.content = eu(c.content, s.index, Pu));
				continue;
			}
			if (b)
				for (r = t.length - 1; r >= 0; r--) {
					let x = t[r];
					if (t[r].level < o) break;
					if (x.single === h && t[r].level === o) {
						x = t[r];
						let m, D;
						h
							? ((m = e.md.options.quotes[2]), (D = e.md.options.quotes[3]))
							: ((m = e.md.options.quotes[0]), (D = e.md.options.quotes[1])),
							(c.content = eu(c.content, s.index, D)),
							(u[x.token].content = eu(u[x.token].content, x.pos, m)),
							(a += D.length - 1),
							x.token === n && (a += m.length - 1),
							(i = c.content),
							(f = i.length),
							(t.length = r);
						continue u;
			...
			d
				? t.push({ token: n, pos: s.index, single: h, level: o })
				: b && h && (c.content = eu(c.content, s.index, Pu));
		}
	}
}
function Be(u) {
	if (u.md.options.typographer)
		for (let e = u.tokens.length - 1; e >= 0; e--)
			u.tokens[e].type !== 'inline' || !Se.test(u.tokens[e].content) || ve(u.tokens[e].children, u);
}
function Te(u) {
	let e, r;
	const t = u.tokens,
...
function yu() {
	this.ruler = new w();
	for (let u = 0; u < du.length; u++) this.ruler.push(du[u][0], du[u][1]);
}
yu.prototype.process = function (u) {
	const e = this.ruler.getRules('');
	for (let r = 0, t = e.length; r < t; r++) e[r](u);
};
yu.prototype.State = r0;
function q(u, e, r, t) {
	(this.src = u),
		(this.md = e),
		(this.env = r),
		...
		(this.level = 0);
	const n = this.src;
	for (let c = 0, o = 0, i = 0, a = 0, f = n.length, s = !1; o < f; o++) {
...
q.prototype.push = function (u, e, r) {
	const t = new T(u, e, r);
	return (
		(t.block = !0),
		r < 0 && this.level--,
...
q.prototype.skipSpacesBack = function (e, r) {
	if (e <= r) return e;
	for (; e > r; ) if (!E(this.src.charCodeAt(--e))) return e + 1;
	return e;
};
q.prototype.skipChars = function (e, r) {
	for (let t = this.src.length; e < t && this.src.charCodeAt(e) === r; e++);
	return e;
};
q.prototype.skipCharsBack = function (e, r, t) {
	if (e <= t) return e;
	for (; e > t; ) if (r !== this.src.charCodeAt(--e)) return e + 1;
	return e;
};
q.prototype.getLines = function (e, r, t, n) {
	if (e >= r) return '';
	...
	for (let o = 0, i = e; i < r; i++, o++) {
		...
		let s = f,
			d;
		for (i + 1 < r || n ? (d = this.eMarks[i] + 1) : (d = this.eMarks[i]); s < d && a < t; ) {
			const b = this.src.charCodeAt(s);
			if (E(b)) b === 9 ? (a += 4 - ((a + this.bsCount[i]) % 4)) : a++;
			else if (s - f < this.tShift[i]) a++;
			else break;
			s++;
		}
		a > t
			? (c[o] = new Array(a - t + 1).join(' ') + this.src.slice(s, d))
			: (c[o] = this.src.slice(s, d));
	}
	return c.join('');
};
q.prototype.Token = T;
...
function Ou(u) {
	...
	for (; t < r; )
		n === 124 &&
			(c
				? ((i += u.substring(o, t - 1)), (o = t))
				: (e.push(i + u.substring(o, t)), (i = ''), (o = t + 1))),
			(c = n === 92),
			t++,
			(n = u.charCodeAt(t));
...
function Ie(u, e, r, t) {
	if (e + 2 > r) return !1;
	let n = e + 1;
	if (u.sCount[n] < u.blkIndent || u.sCount[n] - u.blkIndent >= 4) return !1;
	let c = u.bMarks[n] + u.tShift[n];
	if (c >= u.eMarks[n]) return !1;
	const o = u.src.charCodeAt(c++);
	if ((o !== 124 && o !== 45 && o !== 58) || c >= u.eMarks[n]) return !1;
	const i = u.src.charCodeAt(c++);
	if ((i !== 124 && i !== 45 && i !== 58 && !E(i)) || (o === 45 && E(i))) return !1;
	for (; c < u.eMarks[n]; ) {
		const x = u.src.charCodeAt(c);
		if (x !== 124 && x !== 45 && x !== 58 && !E(x)) return !1;
		c++;
	}
	let a = hu(u, e + 1),
		f = a.split('|');
	...
	for (let x = 0; x < f.length; x++) {
		const m = f[x].trim();
		if (!m) {
			if (x === 0 || x === f.length - 1) continue;
			return !1;
		}
		if (!/^:?-+:?$/.test(m)) return !1;
		m.charCodeAt(m.length - 1) === 58
			? s.push(m.charCodeAt(0) === 58 ? 'center' : 'right')
			: m.charCodeAt(0) === 58
				? s.push('left')
				: s.push('');
	}
	if (((a = hu(u, e).trim()), a.indexOf('|') === -1 || u.sCount[e] - u.blkIndent >= 4)) return !1;
	(f = Ou(a)), f.length && f[0] === '' && f.shift(), f.length && f[f.length - 1] === '' && f.pop();
	const d = f.length;
	...
	for (let x = 0; x < f.length; x++) {
		...
		s[x] && (m.attrs = [['style', 'text-align:' + s[x]]]);
		const D = u.push('inline', '', 0);
		(D.content = f[x].trim()), (D.children = []), u.push('th_close', 'th', -1);
	}
	...
	for (n = e + 2; n < r && !(u.sCount[n] < u.blkIndent); n++) {
		...
		for (let D = 0; D < d; D++) {
			...
			s[D] && (y.attrs = [['style', 'text-align:' + s[D]]]);
			const v = u.push('inline', '', 0);
			(v.content = f[D] ? f[D].trim() : ''), (v.children = []), u.push('td_close', 'td', -1);
		}
		u.push('tr_close', 'tr', -1);
	}
	return (
		p && (u.push('tbody_close', 'tbody', -1), (p[1] = n)),
...
function Me(u, e, r) {
	...
	return (
		(c.content =
			u.getLines(e, n, 4 + u.blkIndent, !1) +
			`
`),
		(c.map = [e, u.line]),
		!0
...
function qe(u, e, r, t) {
	let n = u.bMarks[e] + u.tShift[e],
		c = u.eMarks[e];
	if (u.sCount[e] - u.blkIndent >= 4 || n + 3 > c) return !1;
	...
	let a = n - i;
	if (a < 3) return !1;
	const f = u.src.slice(i, n),
		s = u.src.slice(n, c);
	if (o === 96 && s.indexOf(String.fromCharCode(o)) >= 0) return !1;
	if (t) return !0;
	let d = e,
		b = !1;
	for (
		...
		d++,
			!(
				d >= r ||
				((n = i = u.bMarks[d] + u.tShift[d]), (c = u.eMarks[d]), n < c && u.sCount[d] < u.blkIndent)
			);

	)
		if (
			u.src.charCodeAt(n) === o &&
			!(u.sCount[d] - u.blkIndent >= 4) &&
			((n = u.skipChars(n, o)), !(n - i < a) && ((n = u.skipSpaces(n)), !(n < c)))
		) {
			b = !0;
			break;
		}
...
function Re(u, e, r, t) {
	let n = u.bMarks[e] + u.tShift[e],
		c = u.eMarks[e];
	const o = u.lineMax;
	if (u.sCount[e] - u.blkIndent >= 4 || u.src.charCodeAt(n) !== 62) return !1;
	if (t) return !0;
	const i = [],
		a = [],
		f = [],
	...
	for (l = e; l < r; l++) {
		...
		if (((n = u.bMarks[l] + u.tShift[l]), (c = u.eMarks[l]), n >= c)) break;
		if (u.src.charCodeAt(n++) === 62 && !_) {
			let m = u.sCount[l] + 1,
				D,
				y;
			u.src.charCodeAt(n) === 32
				? (n++, m++, (y = !1), (D = !0))
				: u.src.charCodeAt(n) === 9
					? ((D = !0), (u.bsCount[l] + m) % 4 === 3 ? (n++, m++, (y = !1)) : (y = !0))
					: (D = !1);
			let v = m;
			for (i.push(u.bMarks[l]), u.bMarks[l] = n; n < c; ) {
				const R = u.src.charCodeAt(n);
				if (E(R)) R === 9 ? (v += 4 - ((v + u.bsCount[l] + (y ? 1 : 0)) % 4)) : v++;
				else break;
				n++;
			}
			(h = n >= c),
				a.push(u.bsCount[l]),
				(u.bsCount[l] = u.sCount[l] + 1 + (D ? 1 : 0)),
				f.push(u.sCount[l]),
				(u.sCount[l] = v - m),
				s.push(u.tShift[l]),
				(u.tShift[l] = n - u.bMarks[l]);
			continue;
		}
		if (h) break;
		let x = !1;
...
function ju(u, e) {
	...
	return n < t && ((c = u.src.charCodeAt(n)), !E(c)) ? -1 : n;
}
function Pe(u, e) {
	const r = u.level + 2;
	for (let t = e + 2, n = u.tokens.length - 2; t < n; t++)
		u.tokens[t].level === r &&
			u.tokens[t].type === 'paragraph_open' &&
			((u.tokens[t + 2].hidden = !0), (u.tokens[t].hidden = !0), (t += 2));
}
function Oe(u, e, r, t) {
	let n,
		c,
	...
	if (
		...
		(u.listIndent >= 0 && u.sCount[a] - u.listIndent >= 4 && u.sCount[a] < u.blkIndent)
	)
		return !1;
	let s = !1;
	t && u.parentType === 'paragraph' && u.sCount[a] >= u.blkIndent && (s = !0);
	let d, b, h;
	if ((h = ju(u, a)) >= 0) {
		if (
			((d = !0), (o = u.bMarks[a] + u.tShift[a]), (b = Number(u.src.slice(o, h - 1))), s && b !== 1)
		)
			return !1;
	} else if ((h = Nu(u, a)) >= 0) d = !1;
	else return !1;
	if (s && u.skipSpaces(h) >= u.eMarks[a]) return !1;
	if (t) return !0;
	const l = u.src.charCodeAt(h - 1),
		k = u.tokens.length;
	d
		? ((i = u.push('ordered_list_open', 'ol', 1)), b !== 1 && (i.attrs = [['start', b]]))
		: (i = u.push('bullet_list_open', 'ul', 1));
	const g = [a, 0];
	(i.map = g), (i.markup = String.fromCharCode(l));
	let C = !1;
	const p = u.md.block.ruler.getRules('list'),
		_ = u.parentType;
	for (u.parentType = 'list'; a < r; ) {
		...
		let m = x;
		for (; c < n; ) {
			const j = u.src.charCodeAt(c);
			if (j === 9) m += 4 - ((m + u.bsCount[a]) % 4);
			else if (j === 32) m++;
			else break;
			c++;
		}
		...
		if (
			...
			(u.blkIndent = v),
			(u.tight = !0),
			(u.tShift[a] = D - u.bMarks[a]),
			(u.sCount[a] = m),
			D >= n && u.isEmpty(a + 1)
				? (u.line = Math.min(u.line + 2, r))
				: u.md.block.tokenize(u, a, r, !0),
			(!u.tight || C) && (f = !1),
			(C = u.line - a > 1 && u.isEmpty(u.line - 1)),
			...
			break;
		let vu = !1;
		for (let j = 0, D0 = p.length; j < D0; j++)
			if (p[j](u, a, r, !0)) {
				vu = !0;
				break;
			}
		if (vu) break;
		if (d) {
			if (((h = ju(u, a)), h < 0)) break;
			o = u.bMarks[a] + u.tShift[a];
		} else if (((h = Nu(u, a)), h < 0)) break;
		if (l !== u.src.charCodeAt(h - 1)) break;
	}
	return (
		d ? (i = u.push('ordered_list_close', 'ol', -1)) : (i = u.push('bullet_list_close', 'ul', -1)),
		(i.markup = String.fromCharCode(l)),
		(g[1] = a),
		(u.line = a),
		(u.parentType = _),
...
function Ne(u, e, r, t) {
	let n = u.bMarks[e] + u.tShift[e],
		c = u.eMarks[e],
		o = e + 1;
	if (u.sCount[e] - u.blkIndent >= 4 || u.src.charCodeAt(n) !== 91) return !1;
	function i(p) {
		const _ = u.lineMax;
		if (p >= _ || u.isEmpty(p)) return null;
		let x = !1;
		if ((u.sCount[p] - u.blkIndent > 3 && (x = !0), u.sCount[p] < 0 && (x = !0), !x)) {
			const y = u.md.block.ruler.getRules('reference'),
				v = u.parentType;
			u.parentType = 'reference';
			let R = !1;
			for (let G = 0, su = y.length; G < su; G++)
				if (y[G](u, p, _, !0)) {
					R = !0;
					break;
				}
			if (((u.parentType = v), R)) return null;
		}
		const m = u.bMarks[p] + u.tShift[p],
			D = u.eMarks[p];
	...
	if (f < 0 || a.charCodeAt(f + 1) !== 58) return !1;
	for (n = f + 2; n < c; n++) {
		const p = a.charCodeAt(n);
		if (p === 10) {
			const _ = i(o);
	...
	const s = u.md.helpers.parseLinkDestination(a, n, c);
	if (!s.ok) return !1;
	const d = u.md.normalizeLink(s.str);
	...
	let k = u.md.helpers.parseLinkTitle(a, n, c);
	for (; k.can_continue; ) {
		const p = i(o);
		if (p === null) break;
		(a += p), (n = c), (c = a.length), o++, (k = u.md.helpers.parseLinkTitle(a, n, c, k));
	}
	let g;
	for (
		n < c && l !== n && k.ok ? ((g = k.str), (n = k.pos)) : ((g = ''), (n = b), (o = h));
		n < c;
	...
	if (n < c && a.charCodeAt(n) !== 10 && g)
		for (g = '', n = b, o = h; n < c; ) {
			const p = a.charCodeAt(n);
			if (!E(p)) break;
			n++;
		}
	if (n < c && a.charCodeAt(n) !== 10) return !1;
	const C = ou(a.slice(1, f));
	return C
		? (t ||
				(typeof u.env.references > 'u' && (u.env.references = {}),
				typeof u.env.references[C] > 'u' && (u.env.references[C] = { title: g, href: d }),
				(u.line = o)),
			!0)
		: !1;
}
const je = [
	...
	Ve = '(?:' + Ue + '|' + Ze + '|' + He + ')',
	Ge = '(?:\\s+' + $e + '(?:\\s*=\\s*' + Ve + ')?)',
	t0 = '<[A-Za-z][A-Za-z0-9\\-]*' + Ge + '*\\s*\\/?>',
	c0 = '<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>',
	We = '<!---?>|<!--(?:[^-]|-[^-]|--[^>])*-->',
	Je = '<[?][\\s\\S]*?[?]>',
	Qe = '<![A-Za-z][^>]*>',
	Xe = '<!\\[CDATA\\[[\\s\\S]*?\\]\\]>',
	Ye = new RegExp('^(?:' + t0 + '|' + c0 + '|' + We + '|' + Je + '|' + Qe + '|' + Xe + ')'),
	Ke = new RegExp('^(?:' + t0 + '|' + c0 + ')'),
	$ = [
		...
		[new RegExp(Ke.source + '\\s*$'), /^$/, !1]
	];
function ur(u, e, r, t) {
	let n = u.bMarks[e] + u.tShift[e],
		c = u.eMarks[e];
	if (u.sCount[e] - u.blkIndent >= 4 || !u.md.options.html || u.src.charCodeAt(n) !== 60) return !1;
	let o = u.src.slice(n, c),
		i = 0;
	for (; i < $.length && !$[i][0].test(o); i++);
...
function er(u, e, r, t) {
	...
	if (o !== 35 || n >= c) return !1;
	let i = 1;
	for (o = u.src.charCodeAt(++n); o === 35 && n < c && i <= 6; ) i++, (o = u.src.charCodeAt(++n));
	if (i > 6 || (n < c && !E(o))) return !1;
	if (t) return !0;
	...
	(s.content = u.src.slice(n, c).trim()), (s.map = [e, u.line]), (s.children = []);
...
function rr(u, e, r) {
	...
	for (; i < r && !u.isEmpty(i); i++) {
		...
		if (u.sCount[i] >= u.blkIndent) {
			...
			if (
				...
				(o === 45 || o === 61) && ((h = u.skipChars(h, o)), (h = u.skipSpaces(h)), h >= l))
			) {
				c = o === 61 ? 1 : 2;
				break;
			}
	...
	const s = u.push('inline', '', 0);
	(s.content = a), (s.map = [e, u.line - 1]), (s.children = []);
...
const ru = [
	['table', Ie, ['paragraph', 'reference']],
	['code', Me],
	['fence', qe, ['paragraph', 'reference', 'blockquote', 'list']],
	['blockquote', Re, ['paragraph', 'reference', 'blockquote', 'list']],
	['hr', Le, ['paragraph', 'reference', 'blockquote', 'list']],
	['list', Oe, ['paragraph', 'reference', 'blockquote']],
	['reference', Ne],
	['html_block', ur, ['paragraph', 'reference', 'blockquote']],
	['heading', er, ['paragraph', 'reference', 'blockquote']],
	['lheading', rr],
	['paragraph', nr]
];
function au() {
...
au.prototype.tokenize = function (u, e, r) {
...
K.prototype.pushPending = function () {
...
K.prototype.push = function (u, e, r) {
...
K.prototype.scanDelims = function (u, e) {
	const r = this.posMax,
		t = this.src.charCodeAt(u),
		n = u > 0 ? this.src.charCodeAt(u - 1) : 32;
	let c = u;
	for (; c < r && this.src.charCodeAt(c) === t; ) c++;
	const o = c - u,
		i = c < r ? this.src.charCodeAt(c) : 32,
		a = Q(n) || J(String.fromCharCode(n)),
		f = Q(i) || J(String.fromCharCode(i)),
		s = W(n),
		d = W(i),
		b = !d && (!f || s || a),
		h = !s && (!a || d || f);
	return { can_open: b && (e || !h || a), can_close: h && (e || !b || f), length: o };
};
K.prototype.Token = T;
function tr(u) {
	switch (u) {
...
function cr(u, e) {
	let r = u.pos;
	for (; r < u.posMax && !tr(u.src.charCodeAt(r)); ) r++;
	return r === u.pos ? !1 : (e || (u.pending += u.src.slice(u.pos, r)), (u.pos = r), !0);
}
const ir = /(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i;
function or(u, e) {
	...
	if (!e) {
		...
		s.content = u.md.normalizeLinkText(i);
...
function ar(u, e) {
	...
	for (r++; r < n && E(u.src.charCodeAt(r)); ) r++;
	return (u.pos = r), !0;
}
const wu = [];
for (let u = 0; u < 256; u++) wu.push(0);
...
function fr(u, e) {
	...
	if (n === 10) {
		for (e || u.push('hardbreak', 'br', 0), r++; r < t && ((n = u.src.charCodeAt(r)), !!E(n)); )
			r++;
		return (u.pos = r), !0;
	}
	let c = u.src[r];
	...
	if (!e) {
		...
		n < 256 && wu[n] !== 0 ? (i.content = c) : (i.content = o), (i.markup = o), (i.info = 'escape');
	}
	return (u.pos = r + 1), !0;
}
function sr(u, e) {
	...
	for (; (f = u.src.indexOf('`', a)) !== -1; ) {
		for (a = f + 1; a < c && u.src.charCodeAt(a) === 96; ) a++;
		const s = a - f;
		if (s === i) {
			if (!e) {
...
function dr(u) {
	...
	$u(u, u.delimiters);
	for (let t = 0; t < r; t++) e[t] && e[t].delimiters && $u(u, e[t].delimiters);
}
const i0 = { tokenize: lr, postProcess: dr };
function hr(u, e) {
	const r = u.pos,
		t = u.src.charCodeAt(r);
	if (e || (t !== 95 && t !== 42)) return !1;
	const n = u.scanDelims(u.pos, t === 42);
	for (let c = 0; c < n.length; c++) {
		const o = u.push('text', '', 0);
		(o.content = String.fromCharCode(t)),
			u.delimiters.push({
				marker: t,
				length: n.length,
				token: u.tokens.length - 1,
	...
	for (let t = r - 1; t >= 0; t--) {
		...
		const c = e[n.end],
			o =
				t > 0 &&
				e[t - 1].end === n.end + 1 &&
				e[t - 1].marker === n.marker &&
				e[t - 1].token === n.token - 1 &&
				e[n.end + 1].token === c.token + 1,
		...
		(f.type = o ? 'strong_close' : 'em_close'),
			(f.tag = o ? 'strong' : 'em'),
			(f.nesting = -1),
			(f.markup = o ? i + i : i),
			(f.content = ''),
			o &&
				((u.tokens[e[t - 1].token].content = ''), (u.tokens[e[n.end + 1].token].content = ''), t--);
	}
}
function br(u) {
	const e = u.tokens_meta,
		r = u.tokens_meta.length;
	Uu(u, u.delimiters);
	for (let t = 0; t < r; t++) e[t] && e[t].delimiters && Uu(u, e[t].delimiters);
}
const o0 = { tokenize: hr, postProcess: br };
function pr(u, e) {
	let r,
		t,
		n,
	...
	if (l < d && u.src.charCodeAt(l) === 40) {
		for (f = !1, l++; l < d && ((r = u.src.charCodeAt(l)), !(!E(r) && r !== 10)); l++);
		if (l >= d) return !1;
		if (((a = l), (n = u.md.helpers.parseLinkDestination(u.src, l, u.posMax)), n.ok)) {
			for (
				o = u.md.normalizeLink(n.str), u.md.validateLink(o) ? (l = n.pos) : (o = ''), a = l;
				l < d && ((r = u.src.charCodeAt(l)), !(!E(r) && r !== 10));
				l++
			);
			if (((n = u.md.helpers.parseLinkTitle(u.src, l, u.posMax)), l < d && a !== l && n.ok))
				for (i = n.str, l = n.pos; l < d && ((r = u.src.charCodeAt(l)), !(!E(r) && r !== 10)); l++);
		}
		(l >= d || u.src.charCodeAt(l) !== 41) && (f = !0), l++;
	}
	if (f) {
		...
		if (
			(l < d && u.src.charCodeAt(l) === 91
				? ((a = l + 1),
					...
					l >= 0 ? (t = u.src.slice(a, l++)) : (l = h + 1))
				: (l = h + 1),
			t || (t = u.src.slice(b, h)),
			(c = u.env.references[ou(t)]),
			!c)
		)
			return (u.pos = s), !1;
		(o = c.href), (i = c.title);
...
function xr(u, e) {
	...
	if (((c = l + 1), c < b && u.src.charCodeAt(c) === 40)) {
		for (c++; c < b && ((r = u.src.charCodeAt(c)), !(!E(r) && r !== 10)); c++);
		if (c >= b) return !1;
		for (
			f = c,
				i = u.md.helpers.parseLinkDestination(u.src, c, u.posMax),
				i.ok && ((s = u.md.normalizeLink(i.str)), u.md.validateLink(s) ? (c = i.pos) : (s = '')),
				f = c;
			c < b && ((r = u.src.charCodeAt(c)), !(!E(r) && r !== 10));
			c++
		);
		if (((i = u.md.helpers.parseLinkTitle(u.src, c, u.posMax)), c < b && f !== c && i.ok))
			for (a = i.str, c = i.pos; c < b && ((r = u.src.charCodeAt(c)), !(!E(r) && r !== 10)); c++);
		else a = '';
		...
		if (
			(c < b && u.src.charCodeAt(c) === 91
				? ((f = c + 1),
					...
					c >= 0 ? (n = u.src.slice(f, c++)) : (c = l + 1))
				: (c = l + 1),
			n || (n = u.src.slice(h, l)),
			(o = u.env.references[ou(n)]),
			!o)
		)
			return (u.pos = d), !1;
		(s = o.href), (a = o.title);
	...
	if (!e) {
		t = u.src.slice(h, l);
		const k = [];
		u.md.inline.parse(t, u.md, u.env, k);
		const g = u.push('image', 'img', 0),
			C = [
				['src', s],
				['alt', '']
			];
		(g.attrs = C), (g.children = k), (g.content = t), a && C.push(['title', a]);
	}
	return (u.pos = c), (u.posMax = b), !0;
}
const _r =
		/^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/,
	mr = /^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;
function kr(u, e) {
	let r = u.pos;
...
function Er(u, e) {
	...
	const r = u.posMax,
		t = u.pos;
	if (u.src.charCodeAt(t) !== 60 || t + 2 >= r) return !1;
	const n = u.src.charCodeAt(t + 1);
	if (n !== 33 && n !== 63 && n !== 47 && !Cr(n)) return !1;
	const c = u.src.slice(t).match(Ye);
	if (!c) return !1;
	if (!e) {
		const o = u.push('html_inline', '', 0);
		(o.content = c[0]), gr(o.content) && u.linkLevel++, Dr(o.content) && u.linkLevel--;
	}
	return (u.pos += c[0].length), !0;
}
const Fr = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,
...
function yr(u, e) {
	...
	if (u.src.charCodeAt(r + 1) === 35) {
		const c = u.src.slice(r).match(Fr);
		if (c) {
			if (!e) {
				const o = c[1][0].toLowerCase() === 'x' ? parseInt(c[1].slice(1), 16) : parseInt(c[1], 10),
					i = u.push('text_special', '', 0);
				(i.content = Au(o) ? tu(o) : tu(65533)), (i.markup = c[0]), (i.info = 'entity');
			}
			return (u.pos += c[0].length), !0;
		}
	} else {
		const c = u.src.slice(r).match(Ar);
		if (c) {
			const o = Ku(c[0]);
			if (o !== c[0]) {
				if (!e) {
...
function Zu(u) {
	...
	for (let o = 0; o < r; o++) {
		...
		if (
			(c.push(0),
			(u[t].marker !== i.marker || n !== i.token - 1) && (t = o),
			(n = i.token),
			(i.length = i.length || 0),
			!i.close)
		)
		...
		for (; f > a; f -= c[f] + 1) {
			...
			if (d.marker === i.marker && d.open && d.end < 0) {
				...
				if (
					...
					const h = f > 0 && !u[f - 1].open ? c[f - 1] + 1 : 0;
					(c[o] = o - f + h),
						(c[f] = h),
						(i.open = !1),
						(d.end = o),
		...
		s !== -1 && (e[i.marker][(i.open ? 3 : 0) + ((i.length || 0) % 3)] = s);
	}
}
function wr(u) {
	const e = u.tokens_meta,
		r = u.tokens_meta.length;
	Zu(u.delimiters);
	for (let t = 0; t < r; t++) e[t] && e[t].delimiters && Zu(e[t].delimiters);
}
function Sr(u) {
	let e,
		r,
	...
	for (e = r = 0; e < c; e++)
		n[e].nesting < 0 && t--,
			(n[e].level = t),
			n[e].nesting > 0 && t++,
			n[e].type === 'text' && e + 1 < c && n[e + 1].type === 'text'
...
function uu() {
	this.ruler = new w();
	for (let u = 0; u < bu.length; u++) this.ruler.push(bu[u][0], bu[u][1]);
	this.ruler2 = new w();
	for (let u = 0; u < pu.length; u++) this.ruler2.push(pu[u][0], pu[u][1]);
}
uu.prototype.skipToken = function (u) {
	const e = u.pos,
		r = this.ruler.getRules(''),
		t = r.length,
		n = u.md.options.maxNesting,
		c = u.cache;
	if (typeof c[e] < 'u') {
		u.pos = c[e];
		return;
...
uu.prototype.tokenize = function (u) {
	const e = this.ruler.getRules(''),
		r = e.length,
		t = u.posMax,
		n = u.md.options.maxNesting;
	for (; u.pos < t; ) {
		...
		if (u.level < n) {
			for (let i = 0; i < r; i++)
				if (((o = e[i](u, !1)), o)) {
					if (c >= u.pos) throw new Error("inline rule didn't increment state.pos");
					break;
				}
		}
		if (o) {
...
uu.prototype.parse = function (u, e, r, t) {
	const n = new this.State(u, e, r, t);
	this.tokenize(n);
	const c = this.ruler2.getRules(''),
		o = c.length;
	for (let i = 0; i < o; i++) c[i](n);
};
uu.prototype.State = K;
function vr(u) {
	const e = {};
	(u = u || {}),
		(e.src_Any = Wu.source),
...
const a0 = { fuzzyLink: !0, fuzzyEmail: !0, fuzzyIP: !1 };
function Mr(u) {
	return Object.keys(u || {}).reduce(function (e, r) {
		return e || a0.hasOwnProperty(r);
	}, !1);
}
const qr = {
		'http:': {
	...
	Lr = 'biz|com|edu|gov|net|org|pro|web|xxx|aero|asia|coop|info|museum|name|shop|рф'.split('|');
function Pr(u) {
...
function cu(u) {
	const e = (u.re = vr(u.__opts__)),
		r = u.__tlds__.slice();
	u.onCompile(), u.__tlds_replaced__ || r.push(Rr), r.push(e.src_xn), (e.src_tlds = r.join('|'));
	function t(i) {
	...
	Object.keys(u.__schemas__).forEach(function (i) {
		...
		if (((u.__compiled__[i] = f), Tr(a))) {
			zr(a.validate)
				? (f.validate = Or(a.validate))
				: Hu(a.validate)
					? (f.validate = a.validate)
					: c(i, a),
				Hu(a.normalize)
		...
		n.forEach(function (i) {
			u.__compiled__[u.__schemas__[i]] &&
				((u.__compiled__[i].validate = u.__compiled__[u.__schemas__[i]].validate),
				(u.__compiled__[i].normalize = u.__compiled__[u.__schemas__[i]].normalize));
		}),
		(u.__compiled__[''] = { validate: null, normalize: Vu() });
	const o = Object.keys(u.__compiled__)
		...
		.map(Ir)
		.join('|');
	(u.re.schema_test = RegExp('(^|(?!_)(?:[><｜]|' + e.src_ZPCc + '))(' + o + ')', 'i')),
		(u.re.schema_search = RegExp('(^|(?!_)(?:[><｜]|' + e.src_ZPCc + '))(' + o + ')', 'ig')),
...
function S(u, e) {
	...
	e || (Mr(u) && ((e = u), (u = {}))),
		(this.__opts__ = ku({}, a0, e)),
		(this.__index__ = -1),
		(this.__last_index__ = -1),
		(this.__schema__ = ''),
		(this.__text_cache__ = ''),
		(this.__schemas__ = ku({}, qr, u)),
		(this.__compiled__ = {}),
		(this.__tlds__ = Lr),
...
S.prototype.add = function (e, r) {
	return (this.__schemas__[e] = r), cu(this), this;
};
...
S.prototype.test = function (e) {
	...
	return (
		this.__opts__.fuzzyLink &&
			...
			((f = e.search(this.re.host_fuzzy_test)),
			f >= 0 &&
...
S.prototype.testSchemaAt = function (e, r, t) {
...
S.prototype.match = function (e) {
	...
	this.__index__ >= 0 &&
		...
		(r.push(gu(this, t)), (t = this.__last_index__));
	let n = t ? e.slice(t) : e;
	for (; this.test(n); )
		r.push(gu(this, t)), (n = n.slice(this.__last_index__)), (t += this.__last_index__);
	...
	return (
		...
		r
			? ((this.__tlds__ = this.__tlds__
					.concat(e)
					.sort()
					.filter(function (t, n, c) {
						return t !== c[n - 1];
					})
					.reverse()),
				cu(this),
				this)
			: ((this.__tlds__ = e.slice()), (this.__tlds_replaced__ = !0), cu(this), this)
	);
};
...
function d0(u, e) {
	const r = u.split('@');
	let t = '';
	r.length > 1 && ((t = r[0] + '@'), (u = r[1])), (u = u.replace(Hr, '.'));
	const n = u.split('.'),
		c = Gr(n, e).join('.');
	return t + c;
}
...
const Wr = (u) => String.fromCodePoint(...u),
	Jr = function (u) {
		return u >= 48 && u < 58
			? 26 + (u - 48)
			: u >= 65 && u < 91
	...
	b0 = function (u, e, r) {
		let t = 0;
		for (u = r ? I(u / $r) : u >> 1, u += I(u / e); u > (xu * X) >> 1; t += z) u = I(u / xu);
		return I(t + ((xu + 1) * u) / (u + jr));
	},
	p0 = function (u) {
		const e = [],
			r = u.length;
		let t = 0,
			...
			o = u.lastIndexOf(l0);
		o < 0 && (o = 0);
		for (let i = 0; i < o; ++i) u.charCodeAt(i) >= 128 && L('not-basic'), e.push(u.charCodeAt(i));
		for (let i = o > 0 ? o + 1 : 0; i < r; ) {
			const a = t;
			for (let s = 1, d = z; ; d += z) {
				i >= r && L('invalid-input');
				const b = Jr(u.charCodeAt(i++));
				b >= z && L('invalid-input'), b > I((U - t) / s) && L('overflow'), (t += b * s);
				const h = d <= c ? Su : d >= c + X ? X : d - c;
				if (b < h) break;
				const l = z - h;
				s > I(U / l) && L('overflow'), (s *= l);
			}
			const f = e.length + 1;
			(c = b0(t - a, f, a == 0)),
				I(t / f) > U - n && L('overflow'),
				(n += I(t / f)),
				(t %= f),
				e.splice(t++, 0, n);
		}
	...
	x0 = function (u) {
		...
		let t = s0,
			n = 0,
			c = f0;
		for (const a of u) a < 128 && e.push(_u(a));
		const o = e.length;
		let i = o;
		for (o && e.push(l0); i < r; ) {
			let a = U;
			for (const s of u) s >= t && s < a && (a = s);
			const f = i + 1;
			a - t > I((U - n) / f) && L('overflow'), (n += (a - t) * f), (t = a);
			for (const s of u)
				if ((s < t && ++n > U && L('overflow'), s === t)) {
					let d = n;
					for (let b = z; ; b += z) {
						const h = b <= c ? Su : b >= c + X ? X : b - c;
						if (d < h) break;
						const l = d - h,
							k = z - h;
						e.push(_u(Gu(h + (l % k), 0))), (d = I(l / k));
					}
					e.push(_u(Gu(d, 0))), (c = b0(n, f, i === o)), (n = 0), ++i;
				}
			++n, ++t;
		}
		return e.join('');
	...
	Qr = function (u) {
		return d0(u, function (e) {
			return Ur.test(e) ? p0(e.slice(4).toLowerCase()) : e;
		});
	},
	Xr = function (u) {
		return d0(u, function (e) {
			return Zr.test(e) ? 'xn--' + x0(e) : e;
		});
	},
	_0 = {
		version: '2.3.1',
		ucs2: { decode: h0, encode: Wr },
		decode: p0,
		encode: x0,
		toASCII: Xr,
		toUnicode: Qr
	...
	en = { default: Yr, zero: Kr, commonmark: un },
	rn = /^(vbscript|javascript|file|data):/,
	nn = /^data:image\/(gif|png|jpeg|webp);/;
function tn(u) {
	const e = u.trim().toLowerCase();
	return rn.test(e) ? nn.test(e) : !0;
}
const m0 = ['http:', 'https:', 'mailto:'];
function cn(u) {
	const e = Cu(u, !0);
	if (e.hostname && (!e.protocol || m0.indexOf(e.protocol) >= 0))
		try {
			e.hostname = _0.toASCII(e.hostname);
		} catch {}
	return Y(Du(e));
}
function on(u) {
	...
	if (e.hostname && (!e.protocol || m0.indexOf(e.protocol) >= 0))
		try {
			e.hostname = _0.toUnicode(e.hostname);
		} catch {}
	return Z(Du(e), Z.defaultChars + '%');
}
function B(u, e) {
	if (!(this instanceof B)) return new B(u, e);
	e || Fu(u) || ((e = u || {}), (u = 'default')),
		(this.inline = new uu()),
		(this.block = new au()),
		(this.core = new yu()),
		(this.renderer = new V()),
		(this.linkify = new S()),
		(this.validateLink = tn),
		(this.normalizeLink = cn),
		(this.normalizeLinkText = on),
		(this.utils = ae),
		(this.helpers = iu({}, de)),
		(this.options = {}),
		this.configure(u),
...
B.prototype.configure = function (u) {
	...
	if (Fu(u)) {
		const r = u;
		if (((u = en[r]), !u)) throw new Error('Wrong `markdown-it` preset "' + r + '", check name');
	}
		...
		u.components &&
			Object.keys(u.components).forEach(function (r) {
				u.components[r].rules && e[r].ruler.enableOnly(u.components[r].rules),
					u.components[r].rules2 && e[r].ruler2.enableOnly(u.components[r].rules2);
			}),
		this
	);
};
