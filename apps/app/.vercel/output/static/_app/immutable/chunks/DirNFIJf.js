...
import { I as Ui } from './Cr1aQYRT.js';
import { I as Gi, R as Wa, T as qa, C as Ua } from './DnqHzMrx.js';
import { g as Qi, a as Ji, c as X, B as ge } from './SV1JYOhp.js';
import { S as ze } from './DociSdig.js';
import { A as Ga, W as Qa } from './BdqK6NE2.js';
...
function sc(t) {
	let e,
		n,
		r = t[1].editor.show_inline_title && Eo(t);
	return {
		c() {
	...
	return (
		...
		})),
		{
			...
			l(f) {
				e = be(f, 'DIV', { class: !0 });
				var p = we(e);
				A(n.$$.fragment, p), (s = K(p)), (o = be(p, 'DIV', { class: !0 }));
				var h = we(o);
				A(i.$$.fragment, h), (l = K(h)), A(a.$$.fragment, h), h.forEach(z), p.forEach(z), this.h();
			},
			h() {
...
function Cc(t) {
	...
	return (
		...
		(k = new Ua({ props: { class: 'w-full', $$slots: { default: [Mc] }, $$scope: { ctx: t } } })),
		{
			...
			l(y) {
				A(e.$$.fragment, y), (n = K(y)), (r = be(y, 'DIV', { class: !0 }));
				var D = we(r);
				A(s.$$.fragment, D), (i = K(D)), (l = be(D, 'DIV', { class: !0 }));
				var C = we(l);
				A(a.$$.fragment, C),
					(c = K(C)),
					A(u.$$.fragment, C),
...
function Tc(t) {
	...
	(n = new ze({ props: { options: Ee['editor:search'], callback: t[13] } })),
...
function wc(t) {
	let e, n, r, s;
	return (
		(e = new ze({ props: { options: Ee['notes:toggle-sidebar'] } })),
		(r = new Re({
			props: {
				name: 'sidebarArrow',
		...
		})),
		{
			...
			l(o) {
				A(e.$$.fragment, o), (n = K(o)), A(r.$$.fragment, o);
			},
			m(o, i) {
				E(e, o, i), Q(o, n, i), E(r, o, i), (s = !0);
			},
			p(o, i) {
				const l = {};
	...
	return (
		(e = new Oe({
			props: {
				text: 'Previous note',
				side: 'bottom',
				shortcut: Ee['notes:history-back'],
				$$slots: { default: [Dc] },
				$$scope: { ctx: t }
			}
		})),
		(r = new Oe({
			props: {
				text: 'Next note',
				side: 'bottom',
				shortcut: Ee['notes:history-forward'],
				$$slots: { default: [_c] },
				$$scope: { ctx: t }
			}
		})),
...
function Nc(t) {
	let e, n, r, s;
	return (
		(e = new ze({ props: { options: Ee['notes:history-back'], callback: t[12] } })),
...
function vc(t) {
	let e, n, r, s;
	return (
		(e = new ze({ props: { options: Ee['notes:history-forward'], callback: t[14] } })),
...
function Lc(t) {
	...
	let e,
		...
		s = [];
	for (let l = 0; l < r.length; l += 1) s[l] = No(Ao(t, r, l));
	const o = (l) =>
		M(s[l], 1, 1, () => {
			s[l] = null;
		});
...
function Rc(t) {
	...
	return {
		...
		l(d) {
			A(e.$$.fragment, d), (n = K(d)), i && i.l(d), (s = Ft());
		},
		m(d, f) {
			E(e, d, f), Q(d, n, f), i && i.m(d, f), Q(d, s, f), (o = !0);
		},
		p(d, f) {
			var h, g, m, b;
			const p = {};
...
function zc(t) {
	let e, n, r, s, o, i;
	return (
		(e = new ze({ props: { options: Ee['editor:toggle-mode'] } })),
		(r = new Re({
		...
		(o = new Re({ props: { name: 'glasses', class: X('w-4 h-4', t[7] === 'view' && 'hidden') } })),
		{
			...
			l(l) {
				A(e.$$.fragment, l), (n = K(l)), A(r.$$.fragment, l), (s = K(l)), A(o.$$.fragment, l);
			},
			m(l, a) {
				E(e, l, a), Q(l, n, a), E(r, l, a), Q(l, s, a), E(o, l, a), (i = !0);
			},
			p(l, a) {
				const c = {};
...
function jc(t) {
	let e, n, r, s;
	return (
		(e = new ze({ props: { options: Ee['notes:toggle-details'] } })),
		(r = new Re({
			props: {
				name: 'sidebarArrow',
...
function Wc(t) {
	...
	r = new Oe({
		props: {
			...
			side: 'bottom',
			shortcut: Ee['notes:toggle-sidebar'],
			$$slots: { default: [Ec] },
			$$scope: { ctx: t }
		}
	});
	...
	return (
		...
		(h = new Oe({
			props: {
				...
				side: 'bottom',
				shortcut: Ee['editor:toggle-mode'],
				$$slots: { default: [Hc] },
				$$scope: { ctx: t }
			}
		})),
		...
		(k = new Oe({
			props: {
				text: 'Expand',
				side: 'bottom',
				shortcut: Ee['notes:toggle-details'],
				$$slots: { default: [Kc] },
				$$scope: { ctx: t }
			}
		})),
...
const We = typeof navigator < 'u' ? navigator : null,
	...
	Ve = !Ae && /gecko\/(\d+)/i.test(mt);
Ve && +(/Firefox\/(\d+)/.exec(mt) || [0, 0])[1];
const hs = !Ae && /Chrome\/(\d+)/.exec(mt),
	he = !!hs,
	Xi = hs ? +hs[1] : 0,
	ye = !Ae && !!We && /Apple Computer/.test(We.vendor),
...
`
		...
		if (
			!(s || (d && ye)) &&
			At(l.node, l.offset, u.anchorNode, u.anchorOffset) &&
			At(a.node, a.offset, u.focusNode, u.focusOffset)
		)
			return;
		let f = !1;
		if ((c.extend || e == n) && !d) {
	...
	if ((dl(t, n), !!ul(t))) {
		if (!e && t.input.mouseDown && t.input.mouseDown.allowDefault && he) {
			...
			if (
				r.anchorNode &&
				s.anchorNode &&
				At(r.anchorNode, r.anchorOffset, s.anchorNode, s.anchorOffset)
			) {
				(t.input.mouseDown.delayedSelectionSync = !0), t.domObserver.setCurSelection();
				return;
			}
		}
		if ((t.domObserver.disconnectSelection(), t.cursorWrapper)) Eu(t);
		else {
...
function Eu(t) {
	...
	s ? n.setStart(r.parentNode, de(r) + 1) : n.setStart(r, 0),
		...
		e.removeAllRanges(),
		e.addRange(n),
		!s && !t.state.selection.visible && Ae && ut <= 11 && ((r.disabled = !0), (r.disabled = !1));
}
function dl(t, e) {
	if (e instanceof _) {
...
function Go(t, e, n) {
	...
	if (!s.parent.inlineContent) {
		let i = e < 0 ? s : o,
			l = r instanceof Er ? ne.near(i, e) : ne.findFrom(i, e);
		return l ? st(t, l) : !1;
	}
	return !1;
}
...
class hd {
	...
	onSelectionChange() {
		if (Wo(this.view)) {
			...
			if (Ae && ut <= 11 && !this.view.state.selection.empty) {
	...
	registerMutation(e, n) {
		...
		if (e.type == 'childList') {
			...
			let s = e.previousSibling,
				o = e.nextSibling;
			if (Ae && ut <= 11 && e.addedNodes.length)
				for (let u = 0; u < e.addedNodes.length; u++) {
...
function ni(t, e) {
	...
	return (
		At(i.node, i.offset, s, o) && ([n, r, s, o] = [s, o, n, r]),
...
var pt = {
	...
	Ed = typeof navigator < 'u' && /Mac/.test(navigator.platform),
	Ad =
		typeof navigator < 'u' &&
...
function Od(t) {
	var e =
			(Ed && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey) ||
			(Ad && t.shiftKey && t.key && t.key.length == 1) ||
			t.key == 'Unidentified',
...
const Rd = (t, e) => {
		...
		if (r) {
			...
			s = n.from;
		} else if (((s = Ar(t.doc, n.from, -1)), s == null)) return !1;
		if (e) {
			let o = t.tr.join(s);
	...
	Bd = (t, e) => {
		...
		if (n instanceof _) {
			...
			r = n.to;
		} else if (((r = Ar(t.doc, n.to, 1)), r == null)) return !1;
...
const Hd = (t, e) => {
	...
	Hl = (t, e) => {
		let n = t.selection,
			{ $from: r, $to: s } = n;
		if (n instanceof Er || r.parent.inlineContent || s.parent.inlineContent) return !1;
...
function Vd(t) {
	return (e, n) => {
		...
		let u = e.tr;
		(e.selection instanceof V || e.selection instanceof Er) && u.deleteSelection();
...
function Fl(t, e, n, r) {
	...
	if (
		...
		if (n) {
			...
			h = L.from(s.copy(h));
			let g = t.tr.step(new Et(e.pos - 1, p, e.pos, p, new oe(h, 1, 0), i.length, !0)),
...
function Jd(t, e, n, r, s) {
	...
	t.step(new Et(e.start - (r ? 2 : 0), e.end, e.start, e.end, new oe(o, 0, 0), n.length, !0));
	let i = 0;
...
function Xd(t, e, n, r) {
	let s = t.tr,
		...
		i = r.$to.end(r.depth);
	o < i &&
		(s.step(new Et(o - 1, i, o, i, new oe(L.from(n.create(null, r.parent.copy())), 1, 0), 1, !0)),
	...
	return function (e, n) {
		...
		if (n) {
			let c = a.lastChild && a.lastChild.type == l.type,
				...
				f = o.start,
				p = o.end;
			n(e.tr.step(new Et(f - (c ? 3 : 1), p, f, p, d, 1, !0)).scrollIntoView());
		}
		return !0;
	};
}
		...
		r = new ie({
					...
					return (
						!!a &&
							setTimeout(() => {
								...
								const { from: d } = a,
									f = d + u.length;
								En({ editor: e, from: d, to: f, text: u, rules: n, plugin: r });
							}),
			...
			props: {
				handleTextInput(s, o, i, l) {
					return En({ editor: e, from: o, to: i, text: l, rules: n, plugin: r });
				},
				handleDOMEvents: {
					compositionend: (s) => (
						setTimeout(() => {
							const { $cursor: o } = s.state.selection;
							o && En({ editor: e, from: o.pos, to: o.pos, text: '', rules: n, plugin: r });
						}),
						!1
					)
				},
	...
	return (
		An(t) &&
			...
			Object.keys(e).forEach((r) => {
				An(e[r]) && An(t[r]) ? (n[r] = Lr(t[r], e[r])) : (n[r] = e[r]);
			}),
		n
	);
}
...
function Lf(t, e, n) {
	...
	if (r < e) return;
	const s = t.steps[r];
	if (!(s instanceof qi || s instanceof Et)) return;
...
const pa = fa(!1, !0),
	...
	vh = Me.create({
		...
		addInputRules() {
			return [qt({ find: Ah, type: this.type }), qt({ find: Nh, type: this.type })];
		},
		addPasteRules() {
	...
	Vh = re.create({
		...
		addExtensions() {
			...
			return (
				...
				this.options.horizontalRule !== !1 && t.push(Eh.configure(this.options.horizontalRule)),
		...
		e && ((ws = !e.enabled), (ga = !!e.label), (ba = !!e.labelAfter)),
			t.core.ruler.after('inline', 'github-task-lists', function (n) {
				for (var r = n.tokens, s = 2; s < r.length; s++)
					Mm(r, s) &&
						(Cm(r[s], n.Token),
						Ei(r[s - 2], 'class', 'task-list-item' + (ws ? '' : ' enabled')),
						Ei(r[Sm(r, s - 2)], 'class', 'contains-task-list'));
			});
	};
function Ei(t, e, n) {
	var r = t.attrIndex(e),
...
function Mm(t, e) {
	return Am(t[e]) && Om(t[e - 1]) && Nm(t[e - 2]) && Dm(t[e]);
}
function Cm(t, e) {
	if (
		...
		if (ba) {
			...
			(t.children[0].content = t.children[0].content.slice(0, -1) + ' id="' + n + '">'),
				t.children.push(Em(t.content, n, e));
...
function ka(t, e) {
	return (
		Ai.inline.State.prototype.scanDelims.call({ src: t, posMax: t.length }),
		new Ai.inline.State(t, null, null, []).scanDelims(e, !0)
	);
}
function ya(t, e, n, r) {
...
const pg = q.create({ name: 'taskItem' }),
	...
	Og = [qm, Sa, Qm, Ma, Xm, eg, Rr, ng, sg, lg, cg, dg, hg, gg, kg, $g, Mg, $a, Tg, wg, Ag];
function Xn(t) {
	var e, n;
...
function Gg({ groups: t }) {
	...
	return $(s, kn, k), $(s, fo, Ug), { start: s, tokens: Aa };
}
function Qg(t, e, n) {
	let r = n.length,
		s = 0,
...
function hb(t) {
	let e, n, r, s, o, i, l;
	return (
		(n = new ze({ props: { options: Ee['note:save'], callback: t[2] } })),
		(s = new ze({ props: { options: Ee['note:copy-path'], callback: t[3] } })),
		{
			c() {
			...
			l(a) {
				...
				var c = we(e);
				A(n.$$.fragment, c), (r = K(c)), A(s.$$.fragment, c), c.forEach(z), this.h();
			},
			h() {
			...
			m(a, c) {
				Q(a, e, c), E(n, e, null), J(e, r), E(s, e, null), t[4](e), (l = !0);
			},
			p(a, [c]) {
...
export { Db as E, xb as I, wb as S, Eb as T };
