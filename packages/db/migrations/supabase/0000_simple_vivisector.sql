...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "collection_settings" ADD CONSTRAINT "collection_settings_collection_path_collection_path_fk" FOREIGN KEY ("collection_path") REFERENCES "public"."collection"("path") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "collection_settings" ADD CONSTRAINT "collection_settings_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
